...
#设置基地址
def do_click(index):
    click_url = base_url + "/transaction/post_click?offer_id=317&aff_id=129&aff_sub=SUB1&aff_sub2=SUB2&aff_sub3=SUB3&aff_sub4=SUB4&aff_sub5=SUB5&aff_sub6=testtime" + str(index)
