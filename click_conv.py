...
def click_conv(index,aff_id):
    ...
    click_url = base_url+"/transaction/post_click?offer_id=82849&aff_id="+aff_id+"&aff_sub=SUB1&aff_sub2=SUB2&aff_sub3=SUB3&aff_sub4=SUB4&aff_sub5=SUB5&source=deduct&aff_sub6=testtime"+str(index)
...
for i in range(10):#设置循环次数
    ...
    aff_id=aff_list[random.randint(0,4)]
    print '第%d次请求' % (i + 1)
    #print "aff_id:" + aff_id
