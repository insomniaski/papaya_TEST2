...
def click_conv(index):
    ...
    click_url = base_url+"/transaction/post_click?offer_id=148594&aff_id="+aff_id+"&aff_sub=SUB1&aff_sub2=SUB2&aff_sub3=SUB3&aff_sub4=SUB4&source=batch_create&aff_sub6=test"+sub_str+"&aff_sub5="+current_time
    print click_url
